...
mysql_select_db($database_conexion, $conexion);
$query_mos_imagen = "SELECT * FROM cmd_album order by 1 desc";
...
<div class="row">     
    <div class="col-md-12"> 
        ...
        <div class="box-header">
                                    <h3 class="box-title">Album de Imágenes</h3> 
                                </div>                                                         
                  <div class="box-body">
...
<div class="box-body table-responsive no-padding">
 ...
 // Show if recordset emptyxx ?>
  ...
  <?php do { ?>
    <tr>
      <td><div align="center"><?php echo $row_mos_imagen['alb_id']; ?></div></td>
      ...
      <td><div align="center"><a href="galeria.php?id=<?php echo $row_mos_imagen['alb_id']; ?>" class="fa fa-fw fa-eye" title="Detalle fotos"></a></div></td>
      <td>
        <div align="center"><a href="album_editar.php?id=<?php echo $row_mos_imagen['alb_id']; ?>" title="Editar" class="hide-option">
                <button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button>
              </a></div>
      </td>
      <td>
        <div align="center"><a onclick="return confirm('¿Seguro que desea eliminar?')" href="album_delete.php?id=<?php echo $row_mos_imagen['alb_id']; ?>" title="Eliminar" class="hide-option">
