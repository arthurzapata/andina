...
$query_mos_doc = "SELECT * FROM cmd_servicios WHERE ser_id = $key";
...
//$pro_id= $row_mos_doc['pro_id'];
	...
	if ($row_mos_doc['ser_activo'] == 0) 
		$es = 1;
	elseif($row_mos_doc['ser_activo'] == 1)
		$es = 0;
	
  $deleteSQL = sprintf("update cmd_servicios set ser_activo = $es where ser_id=%s",
