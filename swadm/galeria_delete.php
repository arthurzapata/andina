...
if ((isset($_GET['pk'])) && ($_GET['pk'] != "")) {
  ...
  $query_mos_doc = "SELECT * FROM cmd_fotos WHERE fot_id = $pk";
  ...
  $foto = $row_mos_doc['fot_nombre']; 
  $pro_id = $row_mos_doc['alb_id'];

  $deleteSQL = sprintf("DELETE FROM cmd_fotos WHERE fot_id=%s", GetSQLValueString($_GET['pk'], "int"));
