...
$query_mos_portada = "SELECT * FROM cmd_video order by vid_id desc";
...
<div class="row">     
    <div class="col-md-12"> 
       ...
       <div class="box-header"> 
                  		<h3 class="box-title"><i class="fa fa-briefcase"></i> Videos</h3></div>
                  <div class="box-body">
                  	<div class="row" style="margin-bottom:10px;">
                   		<div class="col-sm-6">
                        	<a class="btn btn-primary" href="video_new.php"><i class="fa fa-pencil"></i> Agregar</a>
						</div>
 ...
 // Show if recordset emptyxx ?>
  ...
  <?php do { ?>
    <tr>
      <td><div align="center"><?php echo $row_mos_portada['vid_id']; ?></div></td>
      <td><div align="center"><?php echo $row_mos_portada['vid_nombre']; ?></div></td> 
      <td><div align="center"><?php echo $row_mos_portada['vid_url']; ?></div></td>
      <td><div align="center"><a href="update_video.php?pk=<?php echo $row_mos_portada['vid_id']; ?>" title="Cambiar Estado">
        <button class="btn btn-<?php if($row_mos_portada['vid_activo']==0) echo 'danger'; else echo 'success'; ?>" type="button"></button>
      </a></div>
      </td>
 
      <td><div align="center"><a href="video_edit.php?id=<?php echo $row_mos_portada['vid_id']; ?>" title="Editar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button></a></div></td>
      <td>
        <div align="center"><a onclick="return confirm('¿Seguro que desea eliminar?')" href="video_delete.php?id=<?php echo $row_mos_portada['vid_id']; ?>" title="Eliminar" class="hide-option">
