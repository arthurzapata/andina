...
$query_mos_portada = "SELECT * FROM cmd_portada where por_idioma='".$_SESSION['idioma']."' order by 1 desc";
...
{
	mysql_select_db($database_conexion, $conexion);
$query_mos_portada = "SELECT * FROM cmd_portada where por_nombre like '%".$_POST['buscar']."%' and  por_idioma='".$_SESSION['idioma']."'";
	$query_limit_mos_portada = sprintf("%s LIMIT %d, %d", $query_mos_portada, $startRow_mos_portada, $maxRows_mos_portada);
	$mos_portada = mysql_query($query_limit_mos_portada, $conexion) or die(mysql_error());
	$row_mos_portada = mysql_fetch_assoc($mos_portada);
}
 ...
 // Show if recordset emptyxx ?>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><div align="center">
      <a rel="lightbox" href="../images/main-slider/<?php echo $row_mos_portada['por_imagen']; ?>"><img  class="example-image" src="../images/main-slider/<?php echo $row_mos_portada['por_imagen']; ?>" width="24px" height="24px"></a>
      </div></td>
