...
*/
  ...
  mysql_select_db($database_conexion, $conexion);
  $query_mos_imagen = "SELECT * FROM cmd_partners  order by 1 desc";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
   ...
   if($_FILES['par_imagen']['tmp_name']!="") { //validamos que input file tenga imagen
      //array de archivos disponibles
      $archivos_disp_ar = array('jpg', 'jpeg', 'gif', 'png');
      //carpteta donde vamos a guardar la imagen
      $carpeta = '../images/clients/';
      //recibimos el campo de imagen
      $FOTO = $_FILES['par_imagen']['tmp_name'];
      //guardamos el nombre original de la imagen en una variable
      $nombrebre_orig = $_FILES['par_imagen']['name'];
  ...
  $insertSQL = sprintf("INSERT INTO cmd_partners (par_descrip, par_imagen) VALUES (%s, %s)",
                       GetSQLValueString($_POST['par_descrip'],"text"),
                       GetSQLValueString($nombre_nuevo,"text"));
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "partners.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row">
    <div class="col-lg-3">
        <div class="form-group">Descripción:
            <input type="text" name="par_descrip" class="form-control" value="">
        </div>    
        <div class="form-group">Imagen:
            <input type="file" name="par_imagen" value="">
        </div>
...
<div class="box-body table-responsive no-padding">
 ...
 // Show if recordset emptyxx ?>
  ...
  <?php do { ?>
    <tr>
      <td><div align="center"><?php echo $row_mos_imagen['par_id']; ?></div></td>
      <td><div align="center"><?php echo $row_mos_imagen['par_descrip']; ?></div></td>
       <td><div align="center">
       <a rel="lightbox[roadtrip]" href="../images/clients/<?php echo $row_mos_imagen['par_imagen']; ?>">
       <img class="example-image" src="../images/clients/<?php echo $row_mos_imagen['par_imagen']; ?>" width="24px" height="24px"></a></div></td>
      ...
      <td>
        <div align="center"><a onclick="return confirm('¿Seguro que desea eliminar?')" href="partners_delete.php?pk=<?php echo $row_mos_imagen['par_id']; ?>" title="Eliminar" class="hide-option">
