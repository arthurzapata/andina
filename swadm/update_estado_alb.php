...
$query_mos_doc = "SELECT * FROM cmd_album WHERE alb_id = $key";
...
//$pro_id= $row_mos_doc['alb_id'];
	if ($row_mos_doc['alb_activo'] == 0) 

		$es = 1;

	elseif($row_mos_doc['alb_activo'] == 1)

		$es = 0;

	

  $deleteSQL = sprintf("update cmd_album set alb_activo = $es where alb_id=%s",
